                        ...
                        <form class="form-horizontal form-bordered" method="post" id="editFormrecommendation">
                            ...
                            <section class="card">
                                <header class="card-header">
                                    <h4 class="card-title">Edit Individual </h4>
                                </header>
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="social_org_div" style="" class="col-md-4 mt-3">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="org_name">Name of organizationsdsdsdsd</label>
                                        ...
                                        <div class="col-md-4 mt-3">
                                          ...
                                          <div class="col-md-4 mt-3">
                                                 ...
                                                 <div class="col-md-4 mt-3">
                                                    ...
                                                    <select name="sector_id[]" id="sector_ids" class="" multiple="multiple">
                 ...
                 <div class="row" id="viewContainer" style="display:none;">
                    <div class="col">
                        <form class="form-horizontal form-bordered" method="post" id="viewFormrecommendation">
                            ...
                            <section class="card">
                                <header class="card-header">
                                    <h4 class="card-title">View Individual</h4>
                                </header>
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Enter Mobile No" pattern="[789][0-9]{9}" maxlength="10" disabled>
                                        </div>
                                        <div class="col-md-4 mt-3">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="area_interest">Areas of Interest</label>
                                            <div class="custom-dropdown" id="areaInterestDropdownfour">
                                                <div class="dropdown-toggle-box" onclick="toggleDropdownfour()">Select Areas</div>
                                        
                                                <div class="dropdown-options" id="dropdownOptionsfour">
                                                    <div class="select-all-container">
                                                        <label><input type="checkbox" id="selectAllfour"> Select All</label>
                                                        <input type="text" class="form-control mt-2" placeholder="Search..." id="sectorSearchfour">
                                                    </div>
                                                    ...
                                                    @foreach($sectors as $sector)
                                                        <div class="mb-2 sector-group">
                                                            <label class="sector-label">
                                                                ...
                                                                <button type="button" class="toggle-subsectorsfour" data-sector-id="{{ $sector->id }}">+</button>
                                                            </label>
                                        ...
                                        <div id="social_org_div" style="" class="col-md-4 mt-3">
                                            <label for="social_org">Do you want to recommend a social Organization(SO)?</label>
                                            <select name="social_org" id="social_org" class="form-control" disabled>
                                                <option value="" disabled selected>--select--</option>
                                                <option value="1">Yes</option>
                                                <option value="0">No</option>
                                            </select>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input type="text" name="org_name" id="org_name" class="form-control" placeholder="Enter Name Of Organization " pattern="^[A-Za-z\s]+$" disabled >
                                        </div>
                                        ...
                                        <div class="col-md-4 mt-3">
                                         ...
                                         <div class="col-md-4 mt-3">
                                            <label for="org_contact_name">Name of Contact person</label>
                                            <input type="text" name="org_contact_name" class="form-control" id="org_contact_name" placeholder="Enter Name of Contact Person" pattern="^[A-Za-z\s]+$" disabled>
                                        </div>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label for="connected_or">Are you connected with the organization in administration capacity?</label>
                                            <select name="is_connected" id="is_connected" class="form-control" disabled>
                                                <option value="" disabled selected>--select--</option>
                                                <option value="1">YES</option>
                                                <option value="0">NO</option>
                                            </select>
                                          ...
                                          <div class="col-md-4 mt-3">
                                                    <label for="visit_induction">Did you visit the organisation yourself?</label>
                                                    {{-- <input type="text" name="is_visited" id="is_visited" class="form-control" placeholder="Enter visit the organisation"  > --}}
                                                    <select name="is_visited" id="is_visited" class="form-control" disabled>
                                                        <option value="" disabled selected>--select--</option>
                                                        <option value="1">YES</option>
                                                        <option value="0">NO</option>
                                                    </select>
                                                ...
                                                <div class="col-md-4 mt-3">
                                                    <label for="sector_id">Sectors(Organization Work In)</label><br>
                                                    <select name="sector_id[]" id="sector_ids" class="js-example-basic-multiple" multiple="multiple" disabled>
                                                        <option value="">-- Select Sector --</option>
                                                        @foreach($sectors as $sector)
                                                            <option value="{{ $sector->id }}">{{ $sector->name }}</option>
                                                        @endforeach
                                                ...
                                                <div class="col-md-4 mt-3">
                                                    <label for="short_description">Your opinion about the SO in short</label>
                                                    <textarea name="opinion" class="form-control" id="opinion" placeholder="Your opinion in short..." rows="2" disabled></textarea>
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                    <label for="comfortable_call">Are you comfortable for a call?</label>
                                    ...
                                    <tbody>
                                        @foreach ($individuallist as $individual)
                                            <tr>
                                                ...
                                                <td>{{ $individual->seva_id }}</td>
                                                <td>{{ $individual->org_name }}</td>
                                                <td>{{ $individual->org_contact_name }}</td> 
                                                
                                                {{-- <td>{{ $individual->orgType?->name}}</td> --}}
                                                {{-- <td>
                                                ...
                                                <td>{{ $individual->org_contact_no }}</td>
                                                <!-- <td>{{ $individual->off_address }}</td> -->
                                                <td>
                                                    @if($individual->status==0)
                                                    <div class="d-flex gap-2">
                                                        <button class="btn btn-success btn-sm approve-element" style="font-size:0.7rem;" title="Approve Evaluation" data-id="{{ $individual->id }}">
                                                            Approve
                                                        </button>
                                                        <button class="btn btn-danger btn-sm reject-element" style="font-size:0.7rem;" title="Reject Evaluation" data-id="{{ $individual->id }}">
                                                            Reject
                                                        </button>
                                                    </div>
                                                    @elseif($individual->status==1)
                                                ...
                                                <td>
                                                    <button class="edit-element btn btn-primary px-2 py-1" title="Edit User" data-id="{{ $individual->id }}">
                                                        <i data-feather="edit"></i>
                                                    </button>
                                                    <br>

                                                    <button class="view-element btn btn-primary px-2 py-1" title="Edit User" data-id="{{ $individual->id }}">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (!data.error2)
                        ...
                        .then((action) => {
                            window.location.href = '{{route('individual_list') }}';
                        });
                    else
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data && data.recommands) {
                    ...
                    $("#viewFormrecommendation input[name='mobile_no']").val(data.recommands.mobile_no);
                    ...
                    $("#viewFormrecommendation select[name='social_org']").val(data.recommands.social_org);
                    ...
                    console.log(data.areaInterestHtml);
                            $('#dropdownOptionsfour').html(data.areaInterestHtml);
...
<script>
    $(document).ready(function() {
        $('#area_interest').select2({
            placeholder: "Select area of sector",
            allowClear: true
        });
    });

    $(document).ready(function() {
        $('#area_interestone').select2({
            placeholder: "Select area of sector",
            allowClear: true
        });
    });
...
<script>
    ...
    function toggleDropdownfour() {
            document.getElementById('dropdownOptionsfour').classList.toggle('show');
        }
        ...
        $(document).ready(function () {
            ...
            // Hide dropdown when clicking outside
            $(document).on('click', function (e) {
                const $dropdown = $('#areaInterestDropdownfour');
                if (!$dropdown.is(e.target) && $dropdown.has(e.target).length === 0) {
                    $('#dropdownOptionsfour').removeClass('show');
                }
            });
            ...
            // Toggle subsectors
            $(document).on('click', '.toggle-subsectorsfour', function () {
                const sectorId = $(this).data('sector-id');
                const $subSectorDiv = $('.subsectorsfour[data-sector-id="' + sectorId + '"]');
                const isHidden = $subSectorDiv.hasClass('d-none');
    
                // Hide all subsectors and reset buttons
                $('.subsectorsfour').addClass('d-none');
                $('.toggle-subsectorsfour').text('+');
            ...
            // Sector search filter
            $(document).on('input', '#sectorSearchfour', function () {
                const query = $(this).val().toLowerCase();
                $('.sector-group').each(function () {
                    const sectorText = $(this).find('.sector-checkbox').parent().text().toLowerCase();
                    const subSectorTexts = $(this).find('.subsector-checkbox').map(function () {
            ...
            // Select All toggle
            $(document).on('change', '#selectAllfour', function () {
                const checked = $(this).prop('checked');
                $('.sector-checkbox, .subsector-checkbox').prop('checked', checked);
            });
            ...
            function updateSelectAllStatus() {
                const all = $('.sector-checkbox, .subsector-checkbox');
                const allChecked = all.length === all.filter(':checked').length;
                $('#selectAllfour').prop('checked', allChecked);
            }
        });
    </script>
