          ...
          <div class="common-banner__content text-center">
             ...
             {{-- <span class="sub-title">
                ...
                <div style="text-align:left;">
                    {{-- <span class="sub-title" style="font-size:50px; color:#e98f09; height:80px; ">
                          Connecting Hearts,</br></br>
                          Empowering Change
                    </span> --}}

                    <h3 style="color:#e98f09;"> <b>Connecting Hearts,</b></br>
                        <b>Empowering Change</b></h3>

                </br></br>
                    <h5 class="title-animation" style="margin-top: 5%;">Your Bridge to Impactful Giving</h5>
...
<div class="partner">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                {{-- <span class="sub-title" style="display: block; text-align: center; color:#046a58;">
                        ...
                        <div class="difference__single-wrapper">
                           <div class="difference__single difference__single-third "
                              ...
                              <div class="difference__single-content">
                                 <h5><a href="cause-details.php">{{ $charity->charity_name }}</a></h5>
                                 <p>{{ $charity->charity_details }}</p>
