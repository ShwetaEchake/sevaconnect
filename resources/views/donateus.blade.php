                              ...
                              <div class="community-donation">
                                 <div class="community-donation__inner">
                                    ...
                                    <div class="donation-form" data-aos-delay="300">
                                       ...
                                       <div class="cta">
                                          <a href="donate-us.html" aria-label="donate us" title="donate us" class="btn--primary">Donate Now <i class="fa-solid fa-arrow-right"></i></a>
                                       </div>
                                    </div>
                                 </div>
                                 <hr>
                                 <div class="checkout__form">
                                    ...
                                    <form action="index.html" method="post">
                                       ...
                                       <div class="input-group">
                                          ...
                                          <div class="input-single">
                                             <input type="text" name="c-phone" id="cPhone" placeholder="Your Number" required="">
                                             <i class="fa-solid fa-phone"></i>
                                          </div>
                                       </div>
                                       <div class="input-single">
                                          <input type="text" name="c-address-two" id="cAddressTwo" placeholder="Your Address" required="">
                                       ...
                                       <div class="form-cta">
                                          <button type="submit" aria-label="submit message" title="submit message" class="btn--primary">Save Informations <i class="fa-solid fa-arrow-right"></i></button>
                                       </div>
                                    </form>
                                 </div>
                              </div>
