      ...
      <div class="swiper-wrapper">
         <div class="swiper-slide">
            <div class="banner-two__slider-single">
               <div class="banner-two__slider-bg" data-background="assets/images/banner/banner-two-bg.png">
               </div>
               <div class="container">
                  <div class="row">
         ...
         <div class="swiper-slide">
            <div class="banner-two__slider-single">
               <div class="banner-two__slider-bg" data-background="assets/images/banner/banner-one-bg.png">
               </div>
               <div class="container">
                  <div class="row">
                     <div class="col-12 col-md-9  col-lg-7 col-xxl-6">
                     ...
                     <div class="swiper-slide">
                        <div class="difference__single-wrapper">
                           <div class="difference__single difference__single-first"
                              data-background="{{asset('frontend/assets/images/difference/bg-one.png')}}">
                              ...
                              <div class="difference__single-content">
                                 <h5><a href="cause-details.php">Child Education</a></h5>
                     ...
                     <div class="swiper-slide">
                        <div class="difference__single-wrapper">
                           <div class="difference__single difference__single-second"
                              data-background="{{asset('frontend/assets/images/difference/bg-two.png')}}">

                              <div class="difference__single-thumb">
                                 <i class="icon-food"></i>
                              </div>
                              <div class="difference__single-content">
                                 <h5><a href="cause-details.php">Healthy Food</a></h5>
                                 <p>Set up a secure and user-friendly online donation platform that accepts multiple
                                 </p>
                              </div>
                           </div>
                     ...
                     <div class="swiper-slide">
                        <div class="difference__single-wrapper">
                           <div class="difference__single difference__single-third "
                              ...
                              <div class="difference__single-content">
                                 <h5><a href="cause-details.php">Medical Care</a></h5>
                                 <p>Set up a secure and user-friendly online donation platform that accepts multiple
                                 </p>
                              </div>
                           </div>
         ...
         <div class="col-12 col-lg-7 col-xxl-6">
            <div class="help__content">
               ...
               <div class="help__content-cta cta">
                  <a href="{{route('aboutus') }}" aria-label="more about us" title="about us"
                     class="btn--primary">More About Us</a>
      ...
      <div class="row gutter-40">
         <div class="col-12 col-xxl-4">
            <div class="cta-section__first cta-section__single">
               <div class="cta-section__group" data-aos="fade-up" data-aos-duration="1000">
                  <div class="thumb">
                     <i class="icon-spread-love"></i>
                  </div>
                  <div class="content">
                     <span>We give child a gift of a education</span>
                     <h3 class="title-animation">Become a volunteer?</h3>
                  </div>
                  <div class="cta-s">
                     <a href="{{route('become-volunteer') }}" aria-label="become a volunteer"
                        title="become a volunteer" class="btn--tertiary">Contact Now</a>
                  </div>
               </div>
               <div class="cta-img">
         ...
         <div class="col-12 col-xxl-4">
            <div class="cta-section__center cta-section__single">
               ...
               <div class="cta-img">
                  <img src="assets/images/cta/two.png" alt="Image" class="parallax-image">
               </div>
            </div>
         </div>
         <div class="col-12 col-xxl-4">
            <div class="cta-section__last cta-section__single">
               <div class="cta-section__group" data-aos="fade-up" data-aos-duration="1000"
                  ...
                  <div class="content">
                     <span>We give child a gift of a education</span>
                     <h3 class="title-animation">Make donation to us?</h3>
                  </div>
                  <div class="cta-s">
                     <a href="{{ route('donate-us')}}" aria-label="make a donation" title="make a donation"
            ...
            <div class="team__single-wrapper" data-aos="fade-up" data-aos-duration="1000">
               <div class="team__single van-tilt">
                  ...
                  <div class="team__single-content">
                     <h6><a href="team-details.php">Michel Fokluz</a></h6>
                     <p>Volunteer</p>
                  </div>
               </div>
            </div>
...
<section class="community">
            ...
            <div class="community-donation" data-aos="fade-up" data-aos-duration="1000">
               <div class="community-donation__inner">
                  ...
                  <div class="donation-form">
                     ...
                     <div class="cta">
                        <a href="{{ route('donate-us')}}" aria-label="donate us" title="donate us"
   ...
   <div class="community-bg">
      <img src="assets/images/community/community-bg.png" alt="Image" class="parallax-image">
   </div>
...
<section class="testimonial" data-background="assets/images/bg-one.png">
   <div class="container">
      <div class="row justify-content-center">
         <div class="col-12 col-md-8 col-xl-7">
            <div class="section__header text-center" data-aos="fade-up" data-aos-duration="1000">
   ...
   <div class="shape" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
      <img src="assets/images/community/shape.png" alt="Image" class="base-img">
   </div>
</section>
               ...
               <div class="cause-two__slider swiper">
                  <div class="swiper-wrapper">
                     <div class="swiper-slide">
                        <div class="cause-two__slider-single">
                           <div class="cause-thumb">
                              <img src="assets/images/cause/five.png" alt="Image">
                              <a href="cause-details.php">
                              <i class="fa-solid fa-arrow-right"></i>
                              </a>
                           </div>
                     ...
                     <div class="swiper-slide">
                        <div class="cause-two__slider-single">
                           <div class="cause-thumb">
                              <img src="assets/images/cause/six.png" alt="Image">
                              <a href="cause-details.php">
                              <i class="fa-solid fa-arrow-right"></i>
                              </a>
                           </div>
                     ...
                     <div class="swiper-slide">
                        <div class="cause-two__slider-single">
                           <div class="cause-thumb">
                              <img src="assets/images/cause/seven.png" alt="Image">
                              <a href="cause-details.php">
                              <i class="fa-solid fa-arrow-right"></i>
                              </a>
                           </div>
                     ...
                     <div class="difference-two__tab">
                        <div class="difference-two__tab-btns">
                           ...
                           <button class="difference-two__tab-btn" data-target="#vision"
                              aria-label="vision" title="vision">Our Vision</button>
...
<section class="blog">
   <div class="container">
      ...
      <div class="row">
         <div class="col-12">
            <div class="section__cta cta text-center">
               <a href="{{route('blog-list') }}" aria-label="our blog" title="our blog" class="btn--primary">View
