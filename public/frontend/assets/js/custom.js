...
(function ($) {
  ...
  jQuery(function () {
    ...
    var causeTwoSliderThumbNeed = new Swiper(".cause-two__content-slider_need", {
        loop: true,
        speed: 1000,
        slidesPerView: 1,
        slidesPerGroup: 1,
        ...
        navigation: {
          nextEl: ".next-cause-two_need",
          prevEl: ".prev-cause-two_need",
        },
      });

      var causeTwoSliderNeed = new Swiper(".cause-two__slider_need", {
        loop: true,
        speed: 1000,
        slidesPerView: 1,
        slidesPerGroup: 1,
        ...
        thumbs: {
          swiper: causeTwoSliderThumbNeed,
        },
        navigation: {
          nextEl: ".next-cause-two_need",
          prevEl: ".prev-cause-two_need",
      ...
      var causeTwoSliderThumbJOB = new Swiper(".cause-two__content-slider_job", {
        loop: true,
        speed: 1000,
        slidesPerView: 1,
        slidesPerGroup: 1,
        ...
        navigation: {
          nextEl: ".next-cause-two_job",
          prevEl: ".prev-cause-two_job",
        },
      });

      var causeTwoSliderJOB = new Swiper(".cause-two__slider_job", {
        loop: true,
        speed: 1000,
        slidesPerView: 1,
        slidesPerGroup: 1,
